...
function MenuItem(props) {
  ...
  let t3;
  if ($[6] !== isSelected || $[7] !== isDisabled || $[8] !== t2 || $[9] !== key || $[10] !== onClose || $[11] !== closeOnSelect || $[12] !== isVirtualized || $[13] !== onAction) {
    t3 = {
      isSelected,
      isDisabled,
      "aria-label": t2,
  ...
  let t6;
  if ($[19] !== role || $[20] !== menuItemProps || $[21] !== hoverProps || $[22] !== focusProps) {
  ...
  let t8;
  if ($[24] !== t6 || $[25] !== t7 || $[26] !== descriptionProps || $[27] !== keyboardShortcutProps || $[28] !== labelProps || $[29] !== isHovered || $[30] !== isFocusVisible || $[31] !== isSelected || $[32] !== ref || $[33] !== contents) {
...
function Menu(props, forwardedRef) {
  ...
  let t4;
  if ($[9] !== state || $[10] !== completeProps.onAction || $[11] !== t3) {
    t4 = t3.map(item => {
  ...
  let t5;
  if ($[13] !== menuProps || $[14] !== styleProps || $[15] !== domRef || $[16] !== t2 || $[17] !== state.selectionManager.selectionMode || $[18] !== t4) {
    t5 = /*#__PURE__*/jsx("div", {
      ...menuProps,
      ...styleProps,
      ref: domRef,
    ...
    $[15] = domRef;
    $[16] = t2;
    $[17] = state.selectionManager.selectionMode;
    $[18] = t4;
    $[19] = t5;
  } else {
    t5 = $[19];
