...
function makeSelectionIterator(e2, r3, t, a, i, o) {
  var s;
  var l = 0;
  return function next() {
    ...
    while (s || l < i.length) {
      ...
      if (s) {
        ...
        var d2 = i[l++];
        if (!shouldInclude(d2, o.variables)) {
        } else if (d2.kind !== e.FIELD) {
          var u = d2.kind !== e.INLINE_FRAGMENT ? o.fragments[getName(d2)] : d2;
          if (u) {
            var p2 = !u.typeCondition || (o.store.schema ? isInterfaceOfType(o.store.schema, u, e2) : "read" === D && isFragmentMatching(u.typeCondition.name.value, e2) || isFragmentHeuristicallyMatching(u, e2, r3, o.variables, o.store.logger));
            if (p2 || "write" === D && !o.store.schema) {
              if (true) {
                pushDebugNode(e2, u);
              }
              var c3 = isOptional(d2);
              if (p2 && u.typeCondition && e2 !== u.typeCondition.name.value) {
                writeConcreteType(u.typeCondition.name.value, e2);
              }
              s = makeSelectionIterator(e2, r3, t || isDeferred(d2, o.variables), void 0 !== c3 ? c3 : a, getSelectionSet(u), o);
            }
          }
        } else if ("write" === D || !d2._generated) {
          return d2;
        }
      }
    }
...
var readRoot = (e2, r3, t, a) => {
  ...
  var i = makeSelectionIterator(r3, r3, false, void 0, t, e2);
  var n;
  var o = V;
  var s = makeData(a);
  while (n = i()) {
...
var readSelection = (e2, r3, t, a, i) => {
  ...
  var v = makeSelectionIterator(l, s, false, void 0, t, e2);
  var d2 = false;
  var u = false;
  var p2 = V;
  var c3;
  ...
  while (void 0 !== (c3 = v())) {
    var h2 = getName(c3);
    var m2 = getFieldArguments(c3, e2.variables);
    var g2 = getFieldAlias(c3);
    var _2 = getDirectives(c3);
    ...
    if ("__typename" === h2) {
      b2 = l;
    } else if (void 0 !== w2 && void 0 === c3.selectionSet) {
      b2 = w2;
    } else if ("read" === D && N2) {
      var x2 = y;
      if (void 0 === c3.selectionSet && void 0 !== O2) {
        x2 = {
          ...y,
          [g2]: O2,
          [h2]: O2
      ...
      b2 = N2(x2, m2 || {}, n, e2);
      if (c3.selectionSet) {
        b2 = resolveResolverResult(e2, l, h2, E2, getSelectionSet(c3), void 0 !== y[g2] ? y[g2] : a[g2], b2, ownsData(a));
      }
      if (n.schema && null === b2 && !isFieldNullable(n.schema, l, h2, e2.store.logger)) {
        return;
      }
    } else if (!c3.selectionSet) {
      b2 = O2;
    } else if (void 0 !== w2) {
      b2 = resolveResolverResult(e2, l, h2, E2, getSelectionSet(c3), void 0 !== y[g2] ? y[g2] : a[g2], w2, ownsData(a));
    } else {
      var I2 = readLink(s, k2);
      if (void 0 !== I2) {
        b2 = resolveLink(e2, I2, l, h2, getSelectionSet(c3), void 0 !== y[g2] ? y[g2] : a[g2], ownsData(a));
      } else if ("object" == typeof O2 && null !== O2) {
        b2 = O2;
      }
    }
    if (!S && void 0 === b2 && (_2.optional || T && !_2.required || getFieldError(e2) || n.schema && isFieldNullable(n.schema, l, h2, e2.store.logger))) {
      e2.partial = true;
      b2 = null;
  ...
  return o && e2.partial && !d2 ? void 0 : p2 ? y : a;
};
var resolveResolverResult = (e2, r3, t, a, i, n, o, s) => {
  if (Array.isArray(o)) {
    ...
    var p2 = V || !Array.isArray(n) || o.length !== n.length;
    for (var c3 = 0, f2 = o.length; c3 < f2; c3++) {
      e2.__internal.path.push(c3);
      var y = resolveResolverResult(e2, r3, t, joinKeys(a, `${c3}`), i, null != n ? n[c3] : void 0, o[c3], s);
      e2.__internal.path.pop();
      if (void 0 === y && !v) {
        e2.partial = d2;
        return;
...
var resolveLink = (e2, r3, t, a, i, n, o) => {
  if (Array.isArray(r3)) {
    ...
    for (var p2 = 0, c3 = r3.length; p2 < c3; p2++) {
      e2.__internal.path.push(p2);
      var f2 = resolveLink(e2, r3[p2], t, a, i, null != n ? n[p2] : void 0, o);
      e2.__internal.path.pop();
      if (void 0 === f2 && !l) {
        e2.partial = d2;
        return;
...
var writeSelection = (e2, r3, t, a) => {
  ...
  var l = makeSelectionIterator(o, r3 || o, false, void 0, t, e2);
  var v;
  while (v = l()) {
    var d2 = getName(v);
    var u = getFieldArguments(v, e2.variables);
    var p2 = keyOfField(d2, u);
    var c3 = getFieldAlias(v);
    var f2 = a[e2.optimistic ? d2 : c3];
    if ("__typename" === d2 || void 0 === f2 && (S || e2.optimistic && "query" === i)) {
      continue;
    }
    if (true) {
    ...
    if (y) {
      updateContext(e2, a, o, r3 || o, p2, d2);
      f2 = ensureData(y(u || {}, e2.store, e2));
    }
    if (void 0 === f2) {
      if (true) {
        if (!r3 || !hasField(r3, p2) || e2.optimistic && !readRecord(r3, "__typename")) {
          warn("Invalid undefined: The field at `" + p2 + "` is `undefined`, but the GraphQL query expects a " + (void 0 === v.selectionSet ? "scalar (number, boolean, etc)" : "selection set") + " for this field.", 13, e2.store.logger);
        }
      }
      continue;
    }
    if (v.selectionSet) {
      if (r3 && "query" === i) {
        var h2 = joinKeys(r3, p2);
        var m2 = writeField(e2, getSelectionSet(v), ensureData(f2), h2, e2.optimistic ? readLink(r3 || o, p2) : void 0);
        writeLink(r3 || o, p2, m2);
      } else {
        writeField(e2, getSelectionSet(v), ensureData(f2));
      }
    } else if (r3 && "query" === i) {
      writeRecord(r3 || o, p2, null !== f2 || !getFieldError(e2) ? f2 : void 0);
    }
    var g2 = s && s[d2];
    if (g2) {
      updateContext(e2, a, o, r3 || o, p2, d2);
...
var writeField = (e2, r3, t, a, i) => {
  ...
  var u = t.__typename;
  if (true) {
    if (a && !e2.store.keys[t.__typename] && null === d2 && "string" == typeof u && !M.test(u)) {
...
*/
//# sourceMappingURL=chunk-VDEQNZXX.js.map
