...
import { Editor, Node, Transforms, Element, Path, Text as Text$1 } from 'slate';
...
function useElementWithSetNodes(editor, element) {
  ...
  const setNodes = t2;
  let t3;
  if ($[6] !== state.elementWithChanges || $[7] !== setNodes) {
    t3 = [state.elementWithChanges, setNodes];
    $[6] = state.elementWithChanges;
    $[7] = setNodes;
    $[8] = t3;
  } else {
    t3 = $[8];
...
function ActiveBlockPopoverProvider(props) {
  ...
  const nodeWithPopover = t0;
  const t1 = nodeWithPopover === null || nodeWithPopover === void 0 ? void 0 : nodeWithPopover[0];
  let t2;
  if ($[2] !== t1 || $[3] !== props.children) {
    t2 = /*#__PURE__*/jsx(ActiveBlockPopoverContext.Provider, {
      value: t1,
      children: props.children
    });
    $[2] = t1;
...
function BlockPopover(props) {
  ...
  let t0;
  if ($[0] !== wrapperRef || $[1] !== props) {
    t0 = /*#__PURE__*/jsx(BlockPopoverWrapper, {
  ...
  let t1;
  if ($[3] !== state.isOpen || $[4] !== wrapperRef || $[5] !== t0) {
...
const BlockPopoverWrapper = t0 => {
  const $ = c(14);
  const {
    children,
    placement: t1
  } = t0;
  const preferredPlacement = t1 === undefined ? "bottom" : t1;
  ...
  let t2;
  if ($[0] !== preferredPlacement || $[1] !== triggerRef || $[2] !== popoverRef) {
    t2 = {
      isNonModal: true,
  ...
  let t4;
  if ($[5] !== children || $[6] !== state) {
    t4 = typeof children === "function" ? children(state.close) : children;
    $[5] = children;
    $[6] = state;
    $[7] = t4;
  } else {
  ...
  let t5;
  if ($[8] !== popoverRef || $[9] !== popoverProps || $[10] !== state.isOpen || $[11] !== placement || $[12] !== t4) {
    t5 = /*#__PURE__*/jsx("div", {
      ref: popoverRef,
      ...popoverProps,
...
const NotEditable = /*#__PURE__*/forwardRef(function NotEditable(t0, ref) {
  const $ = c(10);
  let className;
  let props;
  if ($[0] !== t0) {
