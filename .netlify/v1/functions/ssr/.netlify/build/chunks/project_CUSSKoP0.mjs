import { b as createAstro, c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute } from './astro/server_C89fityf.mjs';
import 'kleur/colors';
import 'clsx';
...
const $$Project = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(url, "href")} target="_blank" class="relative flex flex-col items-stretch duration-300 ease-out p-7 sm:p-3 group h-100 rounded-2xl">
  ...
  <span class="relative z-30 block duration-300 ease-out group-hover:-translate-x-1 group-hover:-translate-y-1">
    <span class="block w-full">
      <img${addAttribute(image, "src")} class="w-full h-auto rounded-lg aspect-[16/9]">
    </span>
...
}, "C:/Users/KATLAV/Documents/GitHub/mysite/src/components/project.astro", void 0);
